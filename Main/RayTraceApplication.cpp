...
IWorldObj* CreateSphere3D(float fRadius, const Vector3& vecPos, GameColor colorEmission, GameColor colorDiffuse,bool bReflect,bool bRefract,float ri = 1.0f,float t = 1.0)
{
...
void RayTraceApplication::SetupScene()
{
	...
	//
	//
	IWorldObj* pSphere1 = CreateSphere3D(300.0f, Vector3(0.0f, -300.0f, 333.0f), GameColor(0.03f, 0.13f, 0.02f, 1.0f), GameColor::white * 0.5f, true, true);
	IWorldObj* pSphere2 = CreateSphere3D(100.0f, Vector3(0.0f, 100.0f, 0.0f), GameColor(0.3f, 0.0f, 0.3f, 1.0f), GameColor::white, true, true);
	IWorldObj* pSphere3 = CreateSphere3D(100.0f, Vector3(-200.0f, 100.0f, 0.0f), GameColor::blue * 0.2, GameColor::white,true,true,1.01,0.4);
	pWorld->m_pRoot->addChild(pSphere1);
	pWorld->m_pRoot->addChild(pSphere2);
	pWorld->m_pRoot->addChild(pSphere3);
	IWorldObj* pSphere4 = CreateSphere3D(100.0f, Vector3(-500.0f, -100.0f, 220.0f), GameColor::blue * 0.2, GameColor::white, true, true,1.02,0.7);
	pWorld->m_pRoot->addChild(pSphere4);

	IWorldObj* pSphere5 = CreateSphere3D(7000.0f, Vector3(0.0f, -100.0f, 12000.0f), GameColor(0.23f, 0.23f, 0.02f, 1.0f), GameColor::white, true, false);

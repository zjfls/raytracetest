...
void TextureEdit::buttonClicked()
{
...
void TextureEdit::focusInEvent(QFocusEvent *e)
{
	theLineEdit->event(e);
...
void TextureEdit::focusOutEvent(QFocusEvent *e)
{
	theLineEdit->event(e);
	QWidget::focusOutEvent(e);
}

void TextureEdit::keyPressEvent(QKeyEvent *e)
{
	theLineEdit->event(e);
}

void TextureEdit::keyReleaseEvent(QKeyEvent *e)
{
	theLineEdit->event(e);
}
